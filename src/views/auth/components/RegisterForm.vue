    ...
    >
      ...
      <div class="">
        <v-checkbox
          ...
          class="mt-n3"
          :rules="[
            v => !!v || 'Acepte los términos y condiciones si quiere continuar'
          ]"
        >
          <template v-slot:label>
            <div class="my-text">
...
<script>
  ...
  import {
    getRole, setProfileInfo,
  } from '@/components/axios/userinfo/userinfo'
  import {
    getEntities,
  } from '@/components/axios/admin/entities'
    ...
    methods: {
      ...
      async registerUser () {
        ...
        try {
          ...
          // }
          // await this.logUser(userDataForLogin)
          this.flashMessage.success({
            status: 'success',
            title: 'Bienvenido a ticket',
            message: 'Bienvenido a nuestra plataforma ticket. Revise su correo para terminar la confirmación.',
          })
        } catch (error) {
